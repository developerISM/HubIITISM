...
public class MDFragment extends Fragment implements LoaderManager.LoaderCallbacks<List<News>> {
    ...
    public android.support.v4.content.Loader<List<News>> onCreateLoader(int id, Bundle args) {
        return new NewsLoader((ClubActivity) getActivity(), ValueStore.getURL(9));
    }
